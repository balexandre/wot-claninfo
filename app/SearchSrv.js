...
(function(){
    ...
    var wotSearch = function ($http, $log) {
        ...
        var applicationId = "3f6379825637847c3c4c6c71b3530cdb";
        ...
        var urlPlayerInfo = "http://api.worldoftanks.eu/wot/account/info/?application_id=" + applicationId + "&account_id=",
            ...
            urlTankInfo = "http://api.worldoftanks.com/wot/encyclopedia/tankinfo/?application_id=demo&tank_id=",
        ...
        var fieldsPlayerLang = ["client_language"],
            ...
            fieldsTankInfo = ["image","level","name_i18n","type","type_i18n","nation_i18n","tank_id"],
            fieldsGarageInfo = [""]; // TODO: use fields to speed up the player information
        ...
        var getPlayerTanksInfoWithGarage = function(playerId) {
            // https://eu.wargaming.net/developers/api_explorer/wot/tanks/stats/?application_id=3f6379825637847c3c4c6c71b3530cdb&fields=in_garage&account_id=500303715&http_method=GET&run=1
            var url = urlGarageTankInfo + playerId;
            $log.info("Getting tanks info for player " + playerId);
            $log.info(url);
            var player = null;
            return $http.get(url)
        ...
        return {
            ...
            "getGarage": getPlayerTanksInfoWithGarage
        };
    };
